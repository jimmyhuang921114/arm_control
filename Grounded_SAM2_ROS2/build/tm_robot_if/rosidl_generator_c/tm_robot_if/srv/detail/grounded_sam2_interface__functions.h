...
#ifndef TM_ROBOT_IF__SRV__DETAIL__GROUNDED_SAM2_INTERFACE__FUNCTIONS_H_
#define TM_ROBOT_IF__SRV__DETAIL__GROUNDED_SAM2_INTERFACE__FUNCTIONS_H_
...
#include "tm_robot_if/msg/rosidl_generator_c__visibility_control.h"

#include "tm_robot_if/srv/detail/grounded_sam2_interface__struct.h"

/// Initialize srv/GroundedSAM2Interface message.
/**
...
/// Create srv/GroundedSAM2Interface message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tm_robot_if__srv__GroundedSAM2Interface_Request__init().
...
/// Destroy srv/GroundedSAM2Interface message.
/**
 * It calls
 * tm_robot_if__srv__GroundedSAM2Interface_Request__fini()
...
/// Check for srv/GroundedSAM2Interface message equality.
/**
...
/// Copy a srv/GroundedSAM2Interface message.
/**
...
/// Initialize array of srv/GroundedSAM2Interface messages.
/**
...
/// Finalize array of srv/GroundedSAM2Interface messages.
/**
 * It calls
 * tm_robot_if__srv__GroundedSAM2Interface_Request__fini()
...
/// Create array of srv/GroundedSAM2Interface messages.
/**
 * It allocates the memory for the array and calls
 * tm_robot_if__srv__GroundedSAM2Interface_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GroundedSAM2Interface messages.
/**
 * It calls
 * tm_robot_if__srv__GroundedSAM2Interface_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GroundedSAM2Interface message array equality.
/**
...
/// Copy an array of srv/GroundedSAM2Interface messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tm_robot_if__srv__GroundedSAM2Interface_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tm_robot_if
...
/**
 * It calls
 * tm_robot_if__srv__GroundedSAM2Interface_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_tm_robot_if
...
/**
 * It allocates the memory for the array and calls
 * tm_robot_if__srv__GroundedSAM2Interface_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tm_robot_if
...
/**
 * It calls
 * tm_robot_if__srv__GroundedSAM2Interface_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TM_ROBOT_IF__SRV__DETAIL__GROUNDED_SAM2_INTERFACE__FUNCTIONS_H_
