...
static const _GroundedSAM2Interface_Request_type_support_symbol_names_t _GroundedSAM2Interface_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interface, srv, GroundedSAM2Interface_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interface, srv, GroundedSAM2Interface_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, interface, srv, GroundedSAM2Interface_Request)() {
  return &::interface::srv::rosidl_typesupport_c::GroundedSAM2Interface_Request_message_type_support_handle;
}
...
static const _GroundedSAM2Interface_Response_type_support_symbol_names_t _GroundedSAM2Interface_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interface, srv, GroundedSAM2Interface_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interface, srv, GroundedSAM2Interface_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, interface, srv, GroundedSAM2Interface_Response)() {
  return &::interface::srv::rosidl_typesupport_c::GroundedSAM2Interface_Response_message_type_support_handle;
}
...
static const _GroundedSAM2Interface_type_support_symbol_names_t _GroundedSAM2Interface_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interface, srv, GroundedSAM2Interface)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interface, srv, GroundedSAM2Interface)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, interface, srv, GroundedSAM2Interface)() {
  return &::interface::srv::rosidl_typesupport_c::GroundedSAM2Interface_service_type_support_handle;
}
