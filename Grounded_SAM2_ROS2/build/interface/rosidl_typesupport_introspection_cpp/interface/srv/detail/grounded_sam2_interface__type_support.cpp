...
{
  new (message_memory) interface::srv::GroundedSAM2Interface_Request(_init);
}

void GroundedSAM2Interface_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interface::srv::GroundedSAM2Interface_Request *>(message_memory);
  typed_message->~GroundedSAM2Interface_Request();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember GroundedSAM2Interface_Request_message_member_array[4] = {
  {
    "prompt",  // name
    ...
    offsetof(interface::srv::GroundedSAM2Interface_Request, prompt),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interface::srv::GroundedSAM2Interface_Request, image),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interface::srv::GroundedSAM2Interface_Request, confidence_threshold),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interface::srv::GroundedSAM2Interface_Request, size_threshold),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GroundedSAM2Interface_Request_message_members = {
  ...
  4,  // number of fields
  sizeof(interface::srv::GroundedSAM2Interface_Request),
...
{
  return &::interface::srv::rosidl_typesupport_introspection_cpp::GroundedSAM2Interface_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interface, srv, GroundedSAM2Interface_Request)() {
  return &::interface::srv::rosidl_typesupport_introspection_cpp::GroundedSAM2Interface_Request_message_type_support_handle;
}
...
void GroundedSAM2Interface_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) interface::srv::GroundedSAM2Interface_Response(_init);
}

void GroundedSAM2Interface_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interface::srv::GroundedSAM2Interface_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GroundedSAM2Interface_Response_message_member_array[2] = {
  {
    "bbox",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_FLOAT,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interface::srv::GroundedSAM2Interface_Response, bbox),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interface::srv::GroundedSAM2Interface_Response, seg),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GroundedSAM2Interface_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(interface::srv::GroundedSAM2Interface_Response),
...
{
  return &::interface::srv::rosidl_typesupport_introspection_cpp::GroundedSAM2Interface_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interface, srv, GroundedSAM2Interface_Response)() {
  return &::interface::srv::rosidl_typesupport_introspection_cpp::GroundedSAM2Interface_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers GroundedSAM2Interface_service_members = {
  ...
  // see get_service_type_support_handle<interface::srv::GroundedSAM2Interface>()
...
get_service_type_support_handle<interface::srv::GroundedSAM2Interface>()
{
  ...
  auto service_type_support =
    &::interface::srv::rosidl_typesupport_introspection_cpp::GroundedSAM2Interface_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interface, srv, GroundedSAM2Interface)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<interface::srv::GroundedSAM2Interface>();
}
