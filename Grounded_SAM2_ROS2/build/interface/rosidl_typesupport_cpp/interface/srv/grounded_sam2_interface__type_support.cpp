...
static const _GroundedSAM2Interface_Request_type_support_symbol_names_t _GroundedSAM2Interface_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface, srv, GroundedSAM2Interface_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interface, srv, GroundedSAM2Interface_Request)),
  }
};
...
{
  return &::interface::srv::rosidl_typesupport_cpp::GroundedSAM2Interface_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interface, srv, GroundedSAM2Interface_Request)() {
  return get_message_type_support_handle<interface::srv::GroundedSAM2Interface_Request>();
}
...
static const _GroundedSAM2Interface_Response_type_support_symbol_names_t _GroundedSAM2Interface_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface, srv, GroundedSAM2Interface_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interface, srv, GroundedSAM2Interface_Response)),
  }
};
...
{
  return &::interface::srv::rosidl_typesupport_cpp::GroundedSAM2Interface_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interface, srv, GroundedSAM2Interface_Response)() {
  return get_message_type_support_handle<interface::srv::GroundedSAM2Interface_Response>();
}
...
static const _GroundedSAM2Interface_type_support_symbol_names_t _GroundedSAM2Interface_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface, srv, GroundedSAM2Interface)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interface, srv, GroundedSAM2Interface)),
  }
};
...
{
  return &::interface::srv::rosidl_typesupport_cpp::GroundedSAM2Interface_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, interface, srv, GroundedSAM2Interface)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<interface::srv::GroundedSAM2Interface>();
}
